...
include ("../../../Php/conexion.php");	
				...
				<table width=500> 
					<tr>
							...
							<th rowspan="2">Extraescolar</th>'; 	
									...
									$sql1="SELECT * FROM actividadesextraescolares WHERE IdActE='$numControlDocente'";
	...
	if(isset($_POST['Imprimir'])){
		...
		header('Content-Disposition: attachment;Filename=EstadisticasIndividual'.$operacion.'.doc');
