...
include ("../../Php/conexion.php"); //Llamado al archivo que conecta a la BD		
	...
	$sql1="SELECT * FROM actividadalumnoavanzado WHERE Id_ctrAlumno='$idAlumno' AND periodoAlumnoAvanzado='$periodoAlumno'";
...
<form action="php/EvaluarAlumnoI.php?id=<?php echo $ver['id_actividadAlumnoAvanzado']?>" method="post">
<center>
...
<table> 
			...
			<tr>
				...
				<td colspan="5">
					<?php
						echo $ver['evaluacionObservacion'];	
					?>
				</td>
			</tr>
			<?php
