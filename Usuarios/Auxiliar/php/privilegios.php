	...
	if(!isset($_SESSION['id'])){
		...
		exit;
			...
			if(isset($_POST['Ingresar'])){ 
				...
				$sqlPromotor="UPDATE tipousuario SET p1='$C1', p2='$C2', p3='$C3', P4='$C4' WHERE IdTipoUsuario='4'";
				...
				$sqlAuxiliar="UPDATE tipousuario SET p1='$B1', p2='$B2', p3='$B3', P4='$B4',p5='$B5', p6='$B6', p7='$B7', P8='$B8', p9='$B9', P0='$B0', aC='$alum', aM='$aM', AD1='$BD' WHERE IdTipoUsuario='3'";
