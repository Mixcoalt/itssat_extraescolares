...
<form action="buscar.php" method="post" >
	...
	<div class="form-row align-items-center">
	 <div class="col-auto">
		<tr> 
	<td>
      <input required name="PalabraClave" type="text" class="form-control mb-2"  placeholder="Ingrese palabra clave">  
	  </td>
	 <td>
	...
	<div class="form-row align-items-center">
	 <div class="col-auto">
		<tr> 
			...
			<td>
				<button class="boton" type="submit" name="acreditados" id="acreditados" class="btn btn-success mb-2">Acreditados</button>
				<button class="boton" type="submit" name="noAcreditados" id="noAcreditados" class="btn btn-success mb-2">No acreditados</button>
			</td>
	  </tr>
    </div>
	</div>
